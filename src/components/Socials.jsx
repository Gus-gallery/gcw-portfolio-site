...
const Socials = () => {
  ...
  return (
    <section id="top" className="relative z-10 flex items-center justify-end opacity-70">

      <div className="container hidden md:flex flex-row items-center justify-end gap-2 -mt-8 -mb-16">
