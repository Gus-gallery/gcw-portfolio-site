    ...
    <section id="education">
        <div className="p-4">
            ...
            <div className="bg-backgroundsecondary rounded-md p-4 mt-4 gradient-border">
                <h2 className="font-regular text-md text-primary">Currently studying</h2>
                ...
                <h2 className="font-regular text-md text-primary mt-4">Digital Design</h2>
                <p className="font-light text-secondary text-md">
                    Course in Digital Design at University of Copenhagen during my bachelor's degree, 2025.
                </p>
                <h2 className="font-regular text-md text-primary mt-4 ">Foundation year in business school</h2>
                <p className="font-light text-secondary text-md">
